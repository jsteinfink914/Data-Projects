...
The data sources for this project are 3-fold: Solar radiation and weather data, Solar Energy Generation and Consumption data, and solar stock data. The full code for this portion of the project can be found [here]()
